        ...
        <header class="text-center mx-auto mb-2">
          <div class="title">
            ...
            <p class="font-weight-normal ambassador_text">
              Our community supports us on the journey to a better world.
              <br />
              Each of them believes in the values and mission of ThreeFold. They
              are proud Token Holders and all have a value-added network.
            </p>
            <p class="home_tf" />
          </div>
        </header>
